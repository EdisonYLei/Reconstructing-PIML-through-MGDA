"""
This code is from Dual cone gradient descent for training physics-informed neural networks (Youngsik Hwang, Dong-Young Lim) - https://github.com/youngsikhwang/Dual-Cone-Gradient-Descent
"""

"""
This code is build upon A Physics-informed Deep Learning Paradigm for Car-following Models (Zhaobin Mo, Rongye Shi, and Xuan Di) - https://github.com/CU-DitecT/TRC21-PINN-CFM
"""
...
def simIDM(para, ini_state, traj_l, delta_t = 0.1):
    ...
    for i in range(1, len(traj_l)):
        # ---------------------------------------------------------
        # 2) Add a small epsilon (EPS) in GA fitness evaluation
        ...
        delta_s = max(delta_s, EPS)
        para[0] = max(para[0], EPS)
